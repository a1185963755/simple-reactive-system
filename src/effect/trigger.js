...
import { targetMap, activeEffect } from "../core/effect.js";

// 定义修改数据和触发数据的映射关系
const triggerTypeMap = {
  [TriggerType.SET]: [TrackType.GET],
  [TriggerType.ADD]: [TrackType.GET, TrackType.ITERATE, TrackType.HAS],
  [TriggerType.DELETE]: [TrackType.GET, TrackType.ITERATE, TrackType.HAS],
};
